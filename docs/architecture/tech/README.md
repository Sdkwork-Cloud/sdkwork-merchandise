...
- [TECH_ARCHITECTURE.md](TECH_ARCHITECTURE.md) is the required entry document. Keep summary, status, and links here.
...
- Do not create competing architecture roots such as `docs/architecture/TECH_ARCHITECTURE.md`; that path is redirect-only.
